...
select source_pool_name, target_pool_name, REASON, count( DISTINCT (100*transaction_id+statement_id)), MAX("time")
...
Where ( eep.node_name ILIKE '%0001' )
